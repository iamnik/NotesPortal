<%-- 
    Document   : TInfo
    Created on : 25 Jul, 2015, 11:53:20 AM
    Author     : Nikhil
--%>
...
<html>
    ...
    <section id="adminbanner">
           ...
           <sql:setDataSource var="usersql" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/project" user="root" password="3306"/>
                ...
                <br><h3>DELETE</h3>
                <center><form action="DeleteFile.jsp">
                ...
                <center><input type="text" placeholder="Paste File Name Here" style="background-color: brown; border-color: white;" name="file_name" ></center><br>
                <center><input class="button" type="submit" value="Delete"></center>
                </form></center>
    </section>
