<%-- 
    Document   : done
    Created on : 14 Jul, 2015, 4:23:26 PM
    Author     : Nikhil
--%>
...
<body class="landing">
    ...
    <!--    <center><button class="button"><a href="#signupScreen">Upload File</a></button></center>   
    <center><button class="button"><a href="#signupScreen">Upload File</a></button></center>     -->
    ...
    <div id="UploadFile" class="form_">  
        ...
        <div align="center"><br><br><br>    
            <form action="UploadServlet" method="post" enctype="multipart/form-data">
                ...
                Select Branch:
                <select class="signup" title="Branch" style="background-color: brown; border-color: white;" name="branch"  required >    
                ...
                Select Year: 
                <select class="signup" title="Year" style="background-color: brown; border-color: white;" name="year" required >
